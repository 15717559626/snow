function TimeTo(dd){
    ...
    document.getElementById('timer').innerHTML = '<p style="margin-top:5px;font-size: 40px;"> <b>'+d+'</b> 天 <b>'+h+'</b> 小时 <b>'+m+'</b> 分</p><p class="ss" style="font-size: 40px;"><b>'+s+'</b> 秒</p>';
//最后这句讲定义好的显示 更新到 ID为 timer的 div中
}
(function(){
    window['ttt']=setInterval(function(){
        TimeTo('2016/2/20 00:00:00');//定义倒计时的结束时间，注意格式
